...
// DataStorageType represents the implementation of data storage
type DataStorageType int

const (
	// FilesystemDataStorage is a plain filesystem-based implementation of storage
	FilesystemDataStorage DataStorageType = iota + 1
	// TSDBDataStorage is based on Prometheus TSDB storage
	TSDBDataStorage
)
...
// Type returns the defined storage type
